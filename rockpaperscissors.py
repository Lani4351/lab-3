...
# then, the computer player randomly chooses  their move, and then we determine who won
# and display a "You won!"" or a "You lost!"  message to the player
...
if (int(player_choice) > 3 or int(player.choice) < 1):
...
if ((player_choice == 1 and ai_choice == 3) or
    ...
    print("You win!")
elif ((player_choice == 1 and ai_choice == 1) or 
      (player_choice == 2 and ai_choice == 2) or 
      (player_choice == 3 and ai_choice == 3)): 
    print("It's a tie!")
else:
    print("You lost!")

# we could check here is the number a
# valid number from 1 to 3